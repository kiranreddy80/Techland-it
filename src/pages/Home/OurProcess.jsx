...
import processRequirements from "/assets/img/icon/process-requirements.png";
import processAgreement from "/assets/img/icon/process-agreement.png";
import processDesign from "/assets/img/icon/process-design.png";
import processDevelopment from "/assets/img/icon/process-development.png";
import processTesting from "/assets/img/icon/process-testing.png";
import processApproval from "/assets/img/icon/process-approval.png";
import processDeployment from "/assets/img/icon/process-deployment.png";
import processUx from "/assets/img/icon/process-ux.png";
import processMonitor from "/assets/img/icon/process-monitor.png";
import marqueeIcon from "/assets/img/icon/marquee-icon1-3.png";
                ...
                {processData.map((process, index) => (
                  <SwiperSlide key={process.step}>
                    ...
                    >
                      ...
                      <p class="box-number"> STEP {process.step.toString().padStart(2, "0")}</p>
