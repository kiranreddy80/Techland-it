...
const Navbar = ({ setOpenContactModal }) => {
  ...
  return (
    <div>
      <div
        className={`th-menu-wrapper onepage-nav ${isMenuOpen ? "th-body-visible" : ""
          }`}
      >
        <div className="th-menu-area text-center">
          <button type="button" className="th-menu-toggle" onClick={toggleMenu}>
          ...
          <div className="th-mobile-menu allow-natural-scroll">
            <ul>
              ...
              <li
                className={`menu-item-has-children ${openSubmenu === "services" ? "open" : ""
                  }`}
              >
                <Link
                  to="#"
                ...
                <ul
                  className={`sub-menu ${openSubmenu === "services" ? "open" : ""
                    }`}
                >
                  <li>
                    <Link
